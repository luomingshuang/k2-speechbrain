...
--------------------------------------------------------------
```
Results based on different lm-scale (k2_HLG+pre-encoder, use-whole-lattices=False, decoding with n-best paths, one GPU):
```
lm-scale\num_paths|  test-clean (WER%) |  test-clean (h:m:s)
--------------------------------------------------------------
        0.0      |        40.57       |      00:12:25
--------------------------------------------------------------
        0.1      |        4.84        |      00:12:10
