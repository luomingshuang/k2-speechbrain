...
--------------------------------------------------------------
        0.0      |        40.57        |  test-clean (h:m:s)
--------------------------------------------------------------
        0.1      |        4.84         |  test-clean (h:m:s)
--------------------------------------------------------------
        0.2      |        4.68         |  test-clean (h:m:s)
--------------------------------------------------------------
        0.3      |<font color=#FF000 >**4.62**</font>|  test-clean (h:m:s)
--------------------------------------------------------------
        0.4      |        4.71         |  test-clean (h:m:s)
--------------------------------------------------------------
        0.5      |        4.84         |  test-clean (h:m:s)
--------------------------------------------------------------
        0.6      |        5.09         |  test-clean (h:m:s)
--------------------------------------------------------------
        0.7      |        5.45         |  test-clean (h:m:s)
--------------------------------------------------------------
        0.8      |        5.91         |  test-clean (h:m:s)
--------------------------------------------------------------
        0.9      |        6.48         |  test-clean (h:m:s)
--------------------------------------------------------------
        1.0      |                |  test-clean (h:m:s)
--------------------------------------------------------------
        1.1      |                |  test-clean (h:m:s)
--------------------------------------------------------------
        1.2      |                |  test-clean (h:m:s)
--------------------------------------------------------------
```
How to run:
```
