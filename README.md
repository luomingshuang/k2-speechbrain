...
----------------------------------------------------------------------------------------------------
    speechbrain (public, lm_weight=0.0, ctc_weight=0.0, bs=1)   |       3.60        |      9.01
----------------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------
    speechbrain (public, lm_weight=0.0, ctc_weight=0.0, bs=1)   |      01:12:22        
--------------------------------------------------------------------------------------
                pre-encoder-output+softmax+greedy               |      00:02:30      
--------------------------------------------------------------------------------------
                  k2_ctc_topo+pre-encoder (bs=8)                |      00:14:00     
--------------------------------------------------------------------------------------
         k2_HLG+pre-encoder (use-whole-lattices=False)          |      00:42:01    
--------------------------------------------------------------------------------------
